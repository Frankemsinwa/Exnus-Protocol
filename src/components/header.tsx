...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 text-gray-800 dark:text-gray-200 border-b border-gray-200 bg-white/80 backdrop-blur-md dark:bg-background/80 dark:border-border/50">
