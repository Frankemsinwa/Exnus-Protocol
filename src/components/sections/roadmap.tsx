...
const roadmapData = [
    { quarter: 'Q1 2025', event: 'Founded' },
    { quarter: 'Q2 2025', event: 'Development Phase and Testing' },
    { quarter: 'Q3 2025', event: 'Airdrop Task Goes Live' },
    { quarter: 'Q3 2025', event: 'Presale Event Launch' },
    { quarter: 'Q4 2025', event: 'Beta DAO and Staking Platform Launched' },
    { quarter: 'Q1 2026', event: 'TGE and Listing' },
];
