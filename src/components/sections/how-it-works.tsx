...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 sm:py-32 bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-headline text-3xl sm:text-4xl font-bold tracking-tight">A Simple Path to Ownership</h2>
        ...
        <div className="mt-20 max-w-5xl mx-auto relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative flex md:items-center flex-col md:flex-row mb-12 last:mb-0">
              ...
              <div className="flex-shrink-0 w-24 h-24 rounded-full bg-primary-foreground flex items-center justify-center my-4 md:my-0 z-10">
                {step.icon}
              </div>
        ...
        <div className="mt-20 text-center">
            <Button size="lg" asChild className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-lg shadow-black/30 transition-all duration-300 transform hover:scale-105">
                <a href="/how-it-works">
